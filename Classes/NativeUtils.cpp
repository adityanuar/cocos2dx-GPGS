...
void NativeUtils::preloadInterstitialAd()
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	JniHelpers::jniCommonVoidCall(
...
void NativeUtils::showInterstitialAd()
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	JniHelpers::jniCommonVoidCall(
		"showInterstitialAd",
...
void NativeUtils::setScreenName(const char* name)
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	JniHelpers::jniCommonVoidCall(
		"setScreenName",
...
void NativeUtils::setEvent(const char* categoryId, const char* actionId, const char* labelId)
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	JniHelpers::jniCommonVoidCall(
		"setEvent",
...
void NativeUtils::loadScoreOfLeaderBoard(const char* leaderboardID)
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	JniHelpers::jniCommonVoidCall(
...
long NativeUtils::getRawScore()
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	return JniHelpers::jniCommonLongCall(
		"getRawScore",
		CLASS_NAME);
#endif
	return 0;
